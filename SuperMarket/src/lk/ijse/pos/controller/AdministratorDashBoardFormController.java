...
public class AdministratorDashBoardFormController {
    ...
    public void navigate(MouseEvent mouseEvent) throws IOException {
        if (mouseEvent.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgItem":
                    root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/pos/view/Item-Form.fxml"));
                    break;
                case "imgReport":
                    root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/pos/view/Report-Form.fxml"));
                    break;
            }
